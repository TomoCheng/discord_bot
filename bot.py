...
async def join_voice_channel(client: discord.Client, voice_channel: discord.VoiceChannel):
...
async def leave_voice_channel(client: discord.Client, voice_channel: discord.VoiceChannel):
    for voice_client in client.voice_clients:
        if voice_client.channel == voice_channel:
